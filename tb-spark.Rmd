...
* Using Apache Spark for large scale repository mining
...
## Source{d} Engine: Spark for Git

[Engine]() is a Spark plugin that

## Dowloading data: The Public Git Archive
...
```bash
$ pga list -u google |wc -l
   1251
$ pga get -u google            # Retrieve data
$ hadoop fs -mkdir /google     # Create upload location
$ hadoop fs -put siva /google/ # Put data to HDFS
```
